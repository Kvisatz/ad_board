                                ...
                                @endforeach
                                    <!-- <div class="col-xs-12 col-sm-6 col-md-4 colp2">
                                        <div class="dropdown yamm-fw checkbox-value">
                                            ...
                                            <div class="dropdown-menu">
                                                <div class="bl-inl al-top cl-check">
                                                    <input id="must[34]1" name="must[34]" type="checkbox" value="ON">
                                                    <label for="must[34]1">Метка на карте</label>
                                                </div>
                                                <br>
                                                <div class="bl-inl al-top cl-check">
                                                    <input id="must[35]1" name="must[35]" type="checkbox" value="ON">
                                                    <label for="must[35]1">Фото</label>
                                                </div>
                                                <br>
                                                <div class="bl-inl al-top cl-check">
                                                    <input id="must[36]1" name="must[36]" type="checkbox" value="ON">
                                                    <label for="must[36]1">Прайс-Лист</label>
                                                </div>
                                                <br>
                                                <div class="bl-inl al-top cl-check">
                                                    <input id="must[37]1" name="must[37]" type="checkbox" value="ON">
                                                    <label for="must[37]1">Видео с YouTube</label>
                                                </div>
                                                <br>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4 colp2">
                                        <select size="1" name="f_5" id="bs_5" class="form-control">
                                            ...
                                            <option value="166">Седан</option>
                                            <option value="167">Хэтчбек</option>
                                            <option value="168">Универсал</option>
                                            <option value="169">Внедорожник</option>
                                            <option value="170">Кабриолет</option>
                                            <option value="171">Купе</option>
                                            <option value="172">Лифтбек</option>
                                        </select>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-4 colp2">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4 colp2">
                                        <select size="1" name="f_7" id="bs_7" class="form-control">
                                            ...
                                            <option value="177">&lt; 5 000</option>
                                            <option value="178">10 000</option>
                                            <option value="179">20 000</option>
                                            <option value="180">30 000</option>
                                            <option value="181">50 000</option>
                                            <option value="182">100 000</option>
                                            <option value="183">&gt; 150 000</option>
                                        </select>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-4 colp2">
                                        <select size="1" name="f_8" id="bs_8" class="form-control">
                                            <option value="">КПП</option>
                                            <option value="184">Автомат</option>
                                            <option value="185">Механика</option>
                                        </select>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-4 colp2">
                                        <div class="dropdown yamm-fw checkbox-value">
                                            ...
                                            <div class="dropdown-menu"> 
                                                <div class="bl-inl al-top cl-check">
                                                    <input class="form-check" id="f_91186f_9" name="f_9[186]" type="checkbox" value="186">
                                                    <label for="f_91186f_9" class="field_label">ABS</label>
                                                </div>
                                                <br>
                                                <div class="bl-inl al-top cl-check">
                                                    <input class="form-check" id="f_91187f_9" name="f_9[187]" type="checkbox" value="187">
                                                    <label for="f_91187f_9" class="field_label">Круиз-контроль</label>
                                                </div>
                                                <br>
                                                <div class="bl-inl al-top cl-check">
                                                    <input class="form-check" id="f_91188f_9" name="f_9[188]" type="checkbox" value="188">
                                                    <label for="f_91188f_9" class="field_label">Подогрев передних сидений</label>
                                                </div>
                                                <br>
                                                <div class="bl-inl al-top cl-check">
                                                    <input class="form-check" id="f_91189f_9" name="f_9[189]" type="checkbox" value="189">
                                                    <label for="f_91189f_9" class="field_label">Усилитель руля</label>
                                                </div>
                                                <br>
                                                <div class="bl-inl al-top cl-check">
                                                    <input class="form-check" id="f_91190f_9" name="f_9[190]" type="checkbox" value="190">
                                                    <label for="f_91190f_9" class="field_label">Люк</label>
                                                </div>
                                                <br>
                                            </div>
                                        </div>  
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4 colp2">
                                        <select size="1" name="f_10" id="bs_10" class="form-control">
                                            ...
                                            <option value="191">Кожа</option>
                                            <option value="192">Велюр</option>
                                            <option value="193">Ткань</option>
                                        </select>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-4 colp2">
                                        <div class="dropdown yamm-fw radio-value">
                                            ...
                                            <div class="dropdown-menu">
                                                <div class="bl-inl al-top cl-radio2">
                                                    <input id="f_11194" value="194" name="f_11" type="radio">
                                                    <label for="f_11194" class="field_label">Светлый</label>
                                                </div>
                                                <br>
                                                <div class="bl-inl al-top cl-radio2">
                                                    <input id="f_11195" value="195" name="f_11" type="radio">
                                                    <label for="f_11195" class="field_label">Темный</label>
                                                </div>
                                                <br>
                                                <div class="bl-inl al-top cl-radio2">
                                                    <input id="f_11195f_11" name="f_11" type="radio" value="">
                                                    <label for="f_11195f_11" class="field_label">не выбрано</label>
                                                </div>  
                                            </div>
                                        </div>  
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-4 colp2">
                                        <select size="1" name="f_30" id="bs_30" class="form-control">
                                            ...
                                            <option value="318">Возможен</option>
                                            <option value="319">Не интересует</option>
                                        </select>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-4 colp2">
                    ...
                    <div class="headerblock br3 b-f ">
                        <div class="headercontent">
                            <p class="text-center" style="margin:0">
                                <a href="https://elite-board.org/dizain.html" target="_blank " title="">
                                    <img alt="" src="/images/cat/design.png">
                                </a>
                            </p>
                        </div>
                    </div>
