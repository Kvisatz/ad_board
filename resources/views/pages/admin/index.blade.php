...
<main class="page-content">
    ...
    <div class="col">
        <div class="card overflow-hidden radius-10">
            ...
            <div class="w-50">
                <p>Всего обьявлений</p>
                <h4 class="">{{ count($adverts) }}</h4>
            </div>
            <div class="w-50">
            ...
            <tbody>
                ...
                <td>
                    ...
                    <div class="product-box border">
                        <img src="assetsadmin/images/products/11.png" alt="">
                    </div>
                ...
                <td>
                    <div class="d-flex align-items-center gap-3">
                    <div class="product-box border">
                        <img src="assetsadmin/images/products/07.png" alt="">
                    </div>
                    <div class="product-info">
                ...
                <td>
                    <div class="d-flex align-items-center gap-3">
                    <div class="product-box border">
                        <img src="assetsadmin/images/products/17.png" alt="">
                    </div>
                    <div class="product-info">
                ...
                <td>
                    <div class="d-flex align-items-center gap-3">
                    <div class="product-box border">
                        <img src="assetsadmin/images/products/04.png" alt="">
                    </div>
                    <div class="product-info">
                ...
                <td>
                    <div class="d-flex align-items-center gap-3">
                    <div class="product-box border">
                        <img src="assetsadmin/images/products/10.png" alt="">
                    </div>
                    <div class="product-info">
                ...
                <td>
                    <div class="d-flex align-items-center gap-3">
                    <div class="product-box border">
                        <img src="assetsadmin/images/products/12.png" alt="">
                    </div>
                    <div class="product-info">
